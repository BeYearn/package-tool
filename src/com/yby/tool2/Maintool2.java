...
public class Maintool2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //现在由手动来反编译 然后删掉assets的art中的history中的中文文件----现在没有啦

            //先反编译
            String decodeDosLine = "java -jar " + rootPath + "\\apktool.jar d " +
                    rootPath + "\\" + ApkName + ".apk";
            CommonTool.Log(decodeDosLine);
            Process decodeProcess = Runtime.getRuntime().exec(decodeDosLine);
            CommonTool.outputDosMes(decodeProcess);
            ...
            for (int i = 0; i < jsonArr.size(); i++) {
                ...
                String mark = "_" + channel + "-" + channelTag;

                String sourceFileStr = rootPath + "\\" + ApkName + "\\dist\\" + ApkName + ".apk";
                String destFileStr = rootPath + "\\out\\" + ApkName + mark + ".apk";
                ...
                String dosLineSign = "java -jar " +
                        ...
                        rootPath + "\\out\\" + ApkName + mark + ".apk " +
                        rootPath + "\\out\\" + ApkName + mark + "_signed.apk";
